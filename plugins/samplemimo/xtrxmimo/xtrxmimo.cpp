...
void XTRXMIMO::webapiFormatDeviceReport(SWGRPX100::SWGDeviceReport& response)
{
    bool success = false;
    double temp = 0.0;
...
void XTRXMIMO::webapiReverseSendSettings(QList<QString>& deviceSettingsKeys, const XTRXMIMOSettings& settings, bool force)
{
    ...
    swgDeviceSettings->setXtrxMimoSettings(new SWGRPX100::SWGXtrxMIMOSettings());
    SWGRPX100::SWGXtrxMIMOSettings *swgXTRXMIMOSettings = swgDeviceSettings->getXtrxMimoSettings();
