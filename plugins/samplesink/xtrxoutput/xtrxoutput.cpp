...
{
    (void) errorMessage;
    response.setXtrxOutputSettings(new SWGRPX100::SWGXtrxOutputSettings());
...
void XTRXOutput::webapiFormatDeviceSettings(SWGRPX100::SWGDeviceSettings& response, const XTRXOutputSettings& settings)
{
...
{
    (void) errorMessage;
    response.setXtrxOutputReport(new SWGRPX100::SWGXtrxOutputReport());
...
void XTRXOutput::webapiFormatDeviceReport(SWGRPX100::SWGDeviceReport& response)
{
    int ret;
    bool success = false;
    double temp = 0.0;
...
void XTRXOutput::webapiReverseSendSettings(QList<QString>& deviceSettingsKeys, const XTRXOutputSettings& settings, bool force)
{
    ...
    swgDeviceSettings->setXtrxOutputSettings(new SWGRPX100::SWGXtrxOutputSettings());
    SWGRPX100::SWGXtrxOutputSettings *swgXtrxOutputSettings = swgDeviceSettings->getXtrxOutputSettings();
