...
{
    (void) errorMessage;
    response.setSoapySdrInputSettings(new SWGRPX100::SWGSoapySDRInputSettings());
        ...
        SWGRPX100::SWGDeviceSettings& response)
{
    ...
    {
        QList<SWGRPX100::SWGArgValue*> *tunableElements = response.getSoapySdrInputSettings()->getTunableElements();
    ...
    {
        QList<SWGRPX100::SWGArgValue*> *individualGains = response.getSoapySdrInputSettings()->getIndividualGains();
    ...
    {
        QList<SWGRPX100::SWGArgValue*> *streamArgSettings = response.getSoapySdrInputSettings()->getStreamArgSettings();
    ...
    {
        QList<SWGRPX100::SWGArgValue*> *deviceArgSettings = response.getSoapySdrInputSettings()->getDeviceArgSettings();
...
int SoapySDRInput::webapiReportGet(SWGRPX100::SWGDeviceReport& response, QString& errorMessage)
{
    (void) errorMessage;
    response.setSoapySdrInputReport(new SWGRPX100::SWGSoapySDRReport());
...
void SoapySDRInput::webapiFormatDeviceSettings(SWGRPX100::SWGDeviceSettings& response, const SoapySDRInputSettings& settings)
{
    ...
    if (response.getSoapySdrInputSettings()->getTunableElements()) {
        ...
        response.getSoapySdrInputSettings()->setTunableElements(new QList<SWGRPX100::SWGArgValue*>);
    }

    for (const auto itName : settings.m_tunableElements.keys())
    {
        response.getSoapySdrInputSettings()->getTunableElements()->append(new SWGRPX100::SWGArgValue);
    ...
    if (response.getSoapySdrInputSettings()->getIndividualGains()) {
        ...
        response.getSoapySdrInputSettings()->setIndividualGains(new QList<SWGRPX100::SWGArgValue*>);
    }

    for (const auto itName : settings.m_individualGains.keys())
    {
        response.getSoapySdrInputSettings()->getIndividualGains()->append(new SWGRPX100::SWGArgValue);
    ...
    if (!response.getSoapySdrInputSettings()->getDcCorrection()) {
        response.getSoapySdrInputSettings()->setDcCorrection(new SWGRPX100::SWGComplex());
    }
    ...
    if (!response.getSoapySdrInputSettings()->getIqCorrection()) {
        response.getSoapySdrInputSettings()->setIqCorrection(new SWGRPX100::SWGComplex());
    }
    ...
    if (response.getSoapySdrInputSettings()->getStreamArgSettings()) {
        ...
        response.getSoapySdrInputSettings()->setStreamArgSettings(new QList<SWGRPX100::SWGArgValue*>);
    }

    for (const auto itName : settings.m_streamArgSettings.keys())
    {
        response.getSoapySdrInputSettings()->getStreamArgSettings()->append(new SWGRPX100::SWGArgValue);
    ...
    if (response.getSoapySdrInputSettings()->getDeviceArgSettings()) {
        ...
        response.getSoapySdrInputSettings()->setDeviceArgSettings(new QList<SWGRPX100::SWGArgValue*>);
    }

    for (const auto itName : settings.m_deviceArgSettings.keys())
    {
        response.getSoapySdrInputSettings()->getDeviceArgSettings()->append(new SWGRPX100::SWGArgValue);
...
void SoapySDRInput::webapiFormatDeviceReport(SWGRPX100::SWGDeviceReport& response)
{
    const DeviceSoapySDRParams::ChannelSettings* channelSettings = m_deviceShared.m_deviceParams->getRxChannelSettings(m_deviceShared.m_channel);

    response.getSoapySdrInputReport()->setDeviceSettingsArgs(new QList<SWGRPX100::SWGArgInfo*>);

    for (const auto itArg : m_deviceShared.m_deviceParams->getDeviceArgs())
    {
        response.getSoapySdrInputReport()->getDeviceSettingsArgs()->append(new SWGRPX100::SWGArgInfo());
        webapiFormatArgInfo(itArg, response.getSoapySdrInputReport()->getDeviceSettingsArgs()->back());
    }

    response.getSoapySdrInputReport()->setStreamSettingsArgs(new QList<SWGRPX100::SWGArgInfo*>);

    for (const auto itArg : channelSettings->m_streamSettingsArgs)
    {
        response.getSoapySdrInputReport()->getStreamSettingsArgs()->append(new SWGRPX100::SWGArgInfo());
        webapiFormatArgInfo(itArg, response.getSoapySdrInputReport()->getStreamSettingsArgs()->back());
    }

    response.getSoapySdrInputReport()->setFrequencySettingsArgs(new QList<SWGRPX100::SWGArgInfo*>);

    for (const auto itArg : channelSettings->m_frequencySettingsArgs)
    {
        response.getSoapySdrInputReport()->getFrequencySettingsArgs()->append(new SWGRPX100::SWGArgInfo());
    ...
    {
        response.getSoapySdrInputReport()->setGainRange(new SWGRPX100::SWGRangeFloat());
    ...
    {
        response.getSoapySdrInputReport()->setGainSettings(new QList<SWGRPX100::SWGSoapySDRGainSetting*>);

        for (const auto itGain : channelSettings->m_gainSettings)
        {
            response.getSoapySdrInputReport()->getGainSettings()->append(new SWGRPX100::SWGSoapySDRGainSetting());
            response.getSoapySdrInputReport()->getGainSettings()->back()->setRange(new SWGRPX100::SWGRangeFloat());
    ...
    {
        response.getSoapySdrInputReport()->setFrequencySettings(new QList<SWGRPX100::SWGSoapySDRFrequencySetting*>);

        for (const auto itFreq : channelSettings->m_frequencySettings)
        {
            response.getSoapySdrInputReport()->getFrequencySettings()->append(new SWGRPX100::SWGSoapySDRFrequencySetting());
            response.getSoapySdrInputReport()->getFrequencySettings()->back()->setRanges(new QList<SWGRPX100::SWGRangeFloat*>);

            for (const auto itRange : itFreq.m_ranges)
            {
                response.getSoapySdrInputReport()->getFrequencySettings()->back()->getRanges()->append(new SWGRPX100::SWGRangeFloat());
    ...
    {
        response.getSoapySdrInputReport()->setRatesRanges(new QList<SWGRPX100::SWGRangeFloat*>);

        for (const auto itRange : channelSettings->m_ratesRanges)
        {
            response.getSoapySdrInputReport()->getRatesRanges()->append(new SWGRPX100::SWGRangeFloat());
    ...
    {
        response.getSoapySdrInputReport()->setBandwidthsRanges(new QList<SWGRPX100::SWGRangeFloat*>);

        for (const auto itBandwidth : channelSettings->m_bandwidthsRanges)
        {
            response.getSoapySdrInputReport()->getBandwidthsRanges()->append(new SWGRPX100::SWGRangeFloat());
...
QVariant SoapySDRInput::webapiVariantFromArgValue(SWGRPX100::SWGArgValue *argValue)
{
...
void SoapySDRInput::webapiFormatArgValue(const QVariant& v, SWGRPX100::SWGArgValue *argValue)
{
...
void SoapySDRInput::webapiFormatArgInfo(const SoapySDR::ArgInfo& arg, SWGRPX100::SWGArgInfo *argInfo)
{
...
void SoapySDRInput::webapiReverseSendSettings(QList<QString>& deviceSettingsKeys, const SoapySDRInputSettings& settings, bool force)
{
    ...
    swgDeviceSettings->setSoapySdrInputSettings(new SWGRPX100::SWGSoapySDRInputSettings());
    swgDeviceSettings->getSoapySdrInputSettings()->init();
    SWGRPX100::SWGSoapySDRInputSettings *swgSoapySDRInputSettings = swgDeviceSettings->getSoapySdrInputSettings();
    ...
    {
        swgSoapySDRInputSettings->setDcCorrection(new SWGRPX100::SWGComplex());
    ...
    {
        swgSoapySDRInputSettings->setIqCorrection(new SWGRPX100::SWGComplex());
