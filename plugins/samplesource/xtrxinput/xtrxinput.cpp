...
{
    (void) errorMessage;
    response.setXtrxInputSettings(new SWGRPX100::SWGXtrxInputSettings());
...
void XTRXInput::webapiFormatDeviceSettings(SWGRPX100::SWGDeviceSettings& response, const XTRXInputSettings& settings)
{
...
{
    (void) errorMessage;
    response.setXtrxInputReport(new SWGRPX100::SWGXtrxInputReport());
...
void XTRXInput::webapiFormatDeviceReport(SWGRPX100::SWGDeviceReport& response)
{
    int ret;
    bool success = false;
    double temp = 0.0;
...
void XTRXInput::webapiReverseSendSettings(QList<QString>& deviceSettingsKeys, const XTRXInputSettings& settings, bool force)
{
    ...
    swgDeviceSettings->setXtrxInputSettings(new SWGRPX100::SWGXtrxInputSettings());
    SWGRPX100::SWGXtrxInputSettings *swgXtrxInputSettings = swgDeviceSettings->getXtrxInputSettings();
