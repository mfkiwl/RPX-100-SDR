...
const char* const BFMDemod::m_channelIdURI = "RPX100.channel.bfm";
...
{
    (void) errorMessage;
    response.setBfmDemodSettings(new SWGRPX100::SWGBFMDemodSettings());
...
{
    (void) errorMessage;
    response.setBfmDemodReport(new SWGRPX100::SWGBFMDemodReport());
    response.getBfmDemodReport()->init();
    webapiFormatChannelReport(response);
    return 200;
}

void BFMDemod::webapiFormatChannelSettings(SWGRPX100::SWGChannelSettings& response, const BFMDemodSettings& settings)
{
...
void BFMDemod::webapiFormatChannelReport(SWGRPX100::SWGChannelReport& response)
{
    ...
    {
        response.getBfmDemodReport()->setRdsReport(new SWGRPX100::SWGRDSReport());
...
void BFMDemod::webapiFormatRDSReport(SWGRPX100::SWGRDSReport *report)
{
    ...
    report->setAltFrequencies(new QList<SWGRPX100::SWGRDSReport_altFrequencies*>);

    for (std::set<double>::iterator it = getRDSParser().m_g0_alt_freq.begin(); it != getRDSParser().m_g0_alt_freq.end(); ++it)
    {
        if (*it > 76.0)
        {
            report->getAltFrequencies()->append(new SWGRPX100::SWGRDSReport_altFrequencies);
...
)
{
    ...
    swgChannelSettings->setBfmDemodSettings(new SWGRPX100::SWGBFMDemodSettings());
    SWGRPX100::SWGBFMDemodSettings *swgBFMDemodSettings = swgChannelSettings->getBfmDemodSettings();
