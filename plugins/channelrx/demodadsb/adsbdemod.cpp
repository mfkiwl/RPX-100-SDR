...
{
    (void) errorMessage;
    response.setAdsbDemodReport(new SWGRPX100::SWGADSBDemodReport());
    response.getAdsbDemodReport()->init();
    webapiFormatChannelReport(response);
    return 200;
}

void ADSBDemod::webapiFormatChannelSettings(SWGRPX100::SWGChannelSettings& response, const ADSBDemodSettings& settings)
{
...
void ADSBDemod::webapiFormatChannelReport(SWGRPX100::SWGChannelReport& response)
{
...
void ADSBDemod::webapiReverseSendSettings(QList<QString>& channelSettingsKeys, const ADSBDemodSettings& settings, bool force)
{
    ...
    swgChannelSettings->setAdsbDemodSettings(new SWGRPX100::SWGADSBDemodSettings());
    SWGRPX100::SWGADSBDemodSettings *swgADSBDemodSettings = swgChannelSettings->getAdsbDemodSettings();
