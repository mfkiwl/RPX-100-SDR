        ...
        SWGRPX100::SWGChannelSettings& response)
{
    ...
    if (channelSettingsKeys.contains("scopeConfig"))
    {
        ...
        {
            QList<SWGRPX100::SWGTraceData *> *tracesData = response.getInterferometerSettings()->getScopeConfig()->getTracesData();
        ...
        {
            QList<SWGRPX100::SWGTriggerData *> *triggersData = response.getInterferometerSettings()->getScopeConfig()->getTriggersData();
