...
SWGDSDDemodSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&demod_gain, pJson["demodGain"], "float", "");
    ...
    ::SWGRPX100::setValue(&enable_cosine_filtering, pJson["enableCosineFiltering"], "qint32", "");
    
    ::SWGRPX100::setValue(&sync_or_constellation, pJson["syncOrConstellation"], "qint32", "");
    
    ::SWGRPX100::setValue(&slot1_on, pJson["slot1On"], "qint32", "");
    
    ::SWGRPX100::setValue(&slot2_on, pJson["slot2On"], "qint32", "");
    
    ::SWGRPX100::setValue(&tdma_stereo, pJson["tdmaStereo"], "qint32", "");
    
    ::SWGRPX100::setValue(&pll_lock, pJson["pllLock"], "qint32", "");
    ...
    ::SWGRPX100::setValue(&high_pass_filter, pJson["highPassFilter"], "qint32", "");
    
    ::SWGRPX100::setValue(&trace_length_mutliplier, pJson["traceLengthMutliplier"], "qint32", "");
    
    ::SWGRPX100::setValue(&trace_stroke, pJson["traceStroke"], "qint32", "");
    
    ::SWGRPX100::setValue(&trace_decay, pJson["traceDecay"], "qint32", "");
