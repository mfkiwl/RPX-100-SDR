...
SWGArgInfo::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&key, pJson["key"], "QString", "QString");
    
    ::SWGRPX100::setValue(&value_type, pJson["valueType"], "QString", "QString");
    
    ::SWGRPX100::setValue(&value_string, pJson["valueString"], "QString", "QString");
    
    ::SWGRPX100::setValue(&name, pJson["name"], "QString", "QString");
    
    ::SWGRPX100::setValue(&description, pJson["description"], "QString", "QString");
    
    ::SWGRPX100::setValue(&units, pJson["units"], "QString", "QString");
    
    ::SWGRPX100::setValue(&range, pJson["range"], "SWGRangeFloat", "SWGRangeFloat");
    
    
    ::SWGRPX100::setValue(&value_options, pJson["valueOptions"], "QList", "QString");
    
    ::SWGRPX100::setValue(&option_names, pJson["optionNames"], "QList", "QString");
}
