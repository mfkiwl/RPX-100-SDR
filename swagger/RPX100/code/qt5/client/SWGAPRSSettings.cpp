...
SWGAPRSSettings::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&igate_server, pJson["igateServer"], "QString", "QString");
    
    ::SWGRPX100::setValue(&igate_port, pJson["igatePort"], "qint32", "");
    
    ::SWGRPX100::setValue(&igate_callsign, pJson["igateCallsign"], "QString", "QString");
    
    ::SWGRPX100::setValue(&igate_passcode, pJson["igatePasscode"], "QString", "QString");
    
    ::SWGRPX100::setValue(&igate_filter, pJson["igateFilter"], "QString", "QString");
    
    ::SWGRPX100::setValue(&igate_enabled, pJson["igateEnabled"], "qint32", "");
