...
SWGAPRSSettings::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&igate_server, pJson["igateServer"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&igate_port, pJson["igatePort"], "qint32", "");
    
    ::SWGrpx-100::setValue(&igate_callsign, pJson["igateCallsign"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&igate_passcode, pJson["igatePasscode"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&igate_filter, pJson["igateFilter"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&igate_enabled, pJson["igateEnabled"], "qint32", "");
