...
SWGDSDDemodReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&pll_locked, pJson["pllLocked"], "qint32", "");
    
    ::SWGRPX100::setValue(&slot1_on, pJson["slot1On"], "qint32", "");
    
    ::SWGRPX100::setValue(&slot2_on, pJson["slot2On"], "qint32", "");
    
    ::SWGRPX100::setValue(&sync_type, pJson["syncType"], "QString", "QString");
    
    ::SWGRPX100::setValue(&in_level, pJson["inLevel"], "qint32", "");
    
    ::SWGRPX100::setValue(&carier_position, pJson["carierPosition"], "qint32", "");
    
    ::SWGRPX100::setValue(&zero_crossing_position, pJson["zeroCrossingPosition"], "qint32", "");
    
    ::SWGRPX100::setValue(&sync_rate, pJson["syncRate"], "qint32", "");
    
    ::SWGRPX100::setValue(&status_text, pJson["statusText"], "QString", "QString");
