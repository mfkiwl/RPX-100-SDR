...
SWGDeviceSet::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&sampling_device, pJson["samplingDevice"], "SWGSamplingDevice", "SWGSamplingDevice");
    
    ::SWGRPX100::setValue(&channelcount, pJson["channelcount"], "qint32", "");
    
    
    ::SWGRPX100::setValue(&channels, pJson["channels"], "QList", "SWGChannel");
}
