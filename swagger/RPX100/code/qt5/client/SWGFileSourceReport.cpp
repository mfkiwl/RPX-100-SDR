...
SWGFileSourceReport::SWGFileSourceReport() {
    ...
    file_sample_rate = 0;
    m_file_sample_rate_isSet = false;
    file_sample_size = 0;
    m_file_sample_size_isSet = false;
...
SWGFileSourceReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&file_sample_rate, pJson["fileSampleRate"], "qint32", "");
    
    ::SWGrpx-100::setValue(&file_sample_size, pJson["fileSampleSize"], "qint32", "");
    
    ::SWGrpx-100::setValue(&absolute_time, pJson["absoluteTime"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&elapsed_time, pJson["elapsedTime"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&duration_time, pJson["durationTime"], "QString", "QString");
...
SWGFileSourceReport::asJsonObject() {
    ...
    if(m_file_sample_rate_isSet){
        obj->insert("fileSampleRate", QJsonValue(file_sample_rate));
    }
    if(m_file_sample_size_isSet){
        obj->insert("fileSampleSize", QJsonValue(file_sample_size));
    }
...
qint32
SWGFileSourceReport::getFileSampleRate() {
    return file_sample_rate;
}
void
SWGFileSourceReport::setFileSampleRate(qint32 file_sample_rate) {
    this->file_sample_rate = file_sample_rate;
    this->m_file_sample_rate_isSet = true;
}

qint32
SWGFileSourceReport::getFileSampleSize() {
    return file_sample_size;
}
void
SWGFileSourceReport::setFileSampleSize(qint32 file_sample_size) {
    this->file_sample_size = file_sample_size;
    this->m_file_sample_size_isSet = true;
}
