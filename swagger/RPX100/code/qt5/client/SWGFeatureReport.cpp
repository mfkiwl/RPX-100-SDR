...
SWGFeatureReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&afc_report, pJson["AFCReport"], "SWGAFCReport", "SWGAFCReport");
    
    ::SWGRPX100::setValue(&simple_ptt_report, pJson["SimplePTTReport"], "SWGSimplePTTReport", "SWGSimplePTTReport");
