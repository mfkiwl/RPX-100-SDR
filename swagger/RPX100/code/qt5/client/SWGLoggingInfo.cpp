...
SWGLoggingInfo::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&console_level, pJson["consoleLevel"], "QString", "QString");
    
    ::SWGRPX100::setValue(&file_level, pJson["fileLevel"], "QString", "QString");
    
    ::SWGRPX100::setValue(&dump_to_file, pJson["dumpToFile"], "qint32", "");
