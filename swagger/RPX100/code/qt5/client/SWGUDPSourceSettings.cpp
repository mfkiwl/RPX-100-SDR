...
SWGUDPSourceSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&input_sample_rate, pJson["inputSampleRate"], "float", "");
    ...
    ::SWGRPX100::setValue(&am_mod_factor, pJson["amModFactor"], "float", "");
    
    ::SWGRPX100::setValue(&channel_mute, pJson["channelMute"], "qint32", "");
    
    ::SWGRPX100::setValue(&gain_in, pJson["gainIn"], "float", "");
    
    ::SWGRPX100::setValue(&gain_out, pJson["gainOut"], "float", "");
    
    ::SWGRPX100::setValue(&squelch, pJson["squelch"], "float", "");
    
    ::SWGRPX100::setValue(&squelch_gate, pJson["squelchGate"], "float", "");
    
    ::SWGRPX100::setValue(&squelch_enabled, pJson["squelchEnabled"], "qint32", "");
    
    ::SWGRPX100::setValue(&auto_rw_balance, pJson["autoRWBalance"], "qint32", "");
    
    ::SWGRPX100::setValue(&stereo_input, pJson["stereoInput"], "qint32", "");
