...
SWGPerseusSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&adc_dither, pJson["adcDither"], "qint32", "");
    
    ::SWGrpx-100::setValue(&adc_preamp, pJson["adcPreamp"], "qint32", "");
    
    ::SWGrpx-100::setValue(&wide_band, pJson["wideBand"], "qint32", "");
    ...
    ::SWGrpx-100::setValue(&attenuator, pJson["attenuator"], "qint32", "");
