...
SWGSatelliteDeviceSettingsList::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&satellite, pJson["satellite"], "QString", "QString");
    
    
    ::SWGrpx-100::setValue(&device_settings, pJson["deviceSettings"], "QList", "SWGSatelliteDeviceSettings");
}
