...
SWGInstanceSummaryResponse::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&version, pJson["version"], "QString", "QString");
    
    ::SWGRPX100::setValue(&qt_version, pJson["qtVersion"], "QString", "QString");
    
    ::SWGRPX100::setValue(&dsp_rx_bits, pJson["dspRxBits"], "qint32", "");
    
    ::SWGRPX100::setValue(&dsp_tx_bits, pJson["dspTxBits"], "qint32", "");
    
    ::SWGRPX100::setValue(&pid, pJson["pid"], "qint32", "");
    
    ::SWGRPX100::setValue(&appname, pJson["appname"], "QString", "QString");
    
    ::SWGRPX100::setValue(&architecture, pJson["architecture"], "QString", "QString");
    
    ::SWGRPX100::setValue(&os, pJson["os"], "QString", "QString");
    
    ::SWGRPX100::setValue(&logging, pJson["logging"], "SWGLoggingInfo", "SWGLoggingInfo");
    
    ::SWGRPX100::setValue(&devicesetlist, pJson["devicesetlist"], "SWGDeviceSetList", "SWGDeviceSetList");
    
    ::SWGRPX100::setValue(&featuresetlist, pJson["featuresetlist"], "SWGFeatureSetList", "SWGFeatureSetList");
