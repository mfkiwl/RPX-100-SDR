...
SWGLocalInputReport::SWGLocalInputReport(QString* json) {
    init();
    this->fromJson(*json);
}
...
void
SWGLocalInputReport::cleanup() {


}

SWGLocalInputReport*
SWGLocalInputReport::fromJson(QString &json) {
...
QJsonObject*
SWGLocalInputReport::asJsonObject() {
...
qint32
SWGLocalInputReport::getSampleRate() {
    return sample_rate;
}
void
SWGLocalInputReport::setSampleRate(qint32 sample_rate) {
