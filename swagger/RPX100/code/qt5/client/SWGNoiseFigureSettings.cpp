...
SWGNoiseFigureSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&fft_count, pJson["fftCount"], "qint32", "");
    
    ::SWGRPX100::setValue(&frequency_spec, pJson["frequencySpec"], "qint32", "");
    
    ::SWGRPX100::setValue(&start_frequency, pJson["startFrequency"], "float", "");
    
    ::SWGRPX100::setValue(&stop_frequency, pJson["stopFrequency"], "float", "");
    
    ::SWGRPX100::setValue(&steps, pJson["steps"], "qint32", "");
    
    ::SWGRPX100::setValue(&step, pJson["step"], "float", "");
    
    ::SWGRPX100::setValue(&frequencies, pJson["frequencies"], "QString", "QString");
    
    ::SWGRPX100::setValue(&visa_device, pJson["visaDevice"], "QString", "QString");
    
    ::SWGRPX100::setValue(&power_on_scpi, pJson["powerOnSCPI"], "QString", "QString");
    
    ::SWGRPX100::setValue(&power_off_scpi, pJson["powerOffSCPI"], "QString", "QString");
    
    ::SWGRPX100::setValue(&power_on_command, pJson["powerOnCommand"], "QString", "QString");
    
    ::SWGRPX100::setValue(&power_off_command, pJson["powerOffCommand"], "QString", "QString");
    
    ::SWGRPX100::setValue(&power_delay, pJson["powerDelay"], "float", "");
