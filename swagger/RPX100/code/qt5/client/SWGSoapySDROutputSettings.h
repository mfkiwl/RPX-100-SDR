...
#ifndef SWGSoapySDROutputSettings_H_
#define SWGSoapySDROutputSettings_H_
...
class SWG_API SWGSoapySDROutputSettings: public SWGObject {
public:
...
#endif /* SWGSoapySDROutputSettings_H_ */
