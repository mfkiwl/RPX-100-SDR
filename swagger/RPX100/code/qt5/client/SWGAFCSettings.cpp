...
SWGAFCSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&tracker_device_set_index, pJson["trackerDeviceSetIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&tracked_device_set_index, pJson["trackedDeviceSetIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&has_target_frequency, pJson["hasTargetFrequency"], "qint32", "");
    
    ::SWGrpx-100::setValue(&transverter_target, pJson["transverterTarget"], "qint32", "");
    
    ::SWGrpx-100::setValue(&target_frequency, pJson["targetFrequency"], "qint64", "");
    
    ::SWGrpx-100::setValue(&freq_tolerance, pJson["freqTolerance"], "qint32", "");
    
    ::SWGrpx-100::setValue(&tracker_adjust_period, pJson["trackerAdjustPeriod"], "qint32", "");
