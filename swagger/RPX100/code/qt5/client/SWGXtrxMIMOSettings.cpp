...
SWGXtrxMIMOSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&rx_dev_sample_rate, pJson["rxDevSampleRate"], "qint32", "");
    ...
    ::SWGRPX100::setValue(&antenna_path_rx, pJson["antennaPathRx"], "qint32", "");
    
    ::SWGRPX100::setValue(&iq_order, pJson["iqOrder"], "qint32", "");
    
    ::SWGRPX100::setValue(&lpf_bw_rx0, pJson["lpfBWRx0"], "qint32", "");
    ...
    ::SWGRPX100::setValue(&pwrmode_rx0, pJson["pwrmodeRx0"], "qint32", "");
    
    ::SWGRPX100::setValue(&lpf_bw_rx1, pJson["lpfBWRx1"], "qint32", "");
    ...
    ::SWGRPX100::setValue(&pwrmode_rx1, pJson["pwrmodeRx1"], "qint32", "");
    
    ::SWGRPX100::setValue(&tx_dev_sample_rate, pJson["txDevSampleRate"], "qint32", "");
    ...
    ::SWGRPX100::setValue(&antenna_path_tx, pJson["antennaPathTx"], "qint32", "");
    
    ::SWGRPX100::setValue(&lpf_bw_tx0, pJson["lpfBWTx0"], "qint32", "");
    
    ::SWGRPX100::setValue(&gain_tx0, pJson["gainTx0"], "qint32", "");
    
    ::SWGRPX100::setValue(&pwrmode_tx0, pJson["pwrmodeTx0"], "qint32", "");
    
    ::SWGRPX100::setValue(&lpf_bw_tx1, pJson["lpfBWTx1"], "qint32", "");
    
    ::SWGRPX100::setValue(&gain_tx1, pJson["gainTx1"], "qint32", "");
    
    ::SWGRPX100::setValue(&pwrmode_tx1, pJson["pwrmodeTx1"], "qint32", "");
