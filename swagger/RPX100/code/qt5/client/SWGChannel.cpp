...
SWGChannel::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&uid, pJson["uid"], "qint64", "");
    
    ::SWGRPX100::setValue(&title, pJson["title"], "QString", "QString");
    
    ::SWGRPX100::setValue(&delta_frequency, pJson["deltaFrequency"], "qint32", "");
    
    ::SWGRPX100::setValue(&report, pJson["report"], "SWGChannelReport", "SWGChannelReport");
