...
SWGSSBModSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&bandwidth, pJson["bandwidth"], "float", "");
    ...
    ::SWGRPX100::setValue(&cmp_pre_gain_db, pJson["cmpPreGainDB"], "qint32", "");
    
    ::SWGRPX100::setValue(&cmp_threshold_db, pJson["cmpThresholdDB"], "qint32", "");
