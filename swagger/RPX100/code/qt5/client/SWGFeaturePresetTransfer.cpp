...
SWGFeaturePresetTransfer::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&feature_set_index, pJson["featureSetIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&preset, pJson["preset"], "SWGFeaturePresetIdentifier", "SWGFeaturePresetIdentifier");
