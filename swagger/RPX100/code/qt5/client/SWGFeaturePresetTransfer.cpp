...
SWGFeaturePresetTransfer::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&feature_set_index, pJson["featureSetIndex"], "qint32", "");
    
    ::SWGRPX100::setValue(&preset, pJson["preset"], "SWGFeaturePresetIdentifier", "SWGFeaturePresetIdentifier");
