...
SWGDATVModSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&ts_source, pJson["tsSource"], "qint32", "");
    
    ::SWGrpx-100::setValue(&ts_file_name, pJson["tsFileName"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&ts_file_play_loop, pJson["tsFilePlayLoop"], "qint32", "");
    
    ::SWGrpx-100::setValue(&ts_file_play, pJson["tsFilePlay"], "qint32", "");
