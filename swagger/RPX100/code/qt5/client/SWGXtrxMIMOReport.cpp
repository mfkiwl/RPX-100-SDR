...
SWGXtrxMIMOReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&gps_lock, pJson["gpsLock"], "qint32", "");
    
    ::SWGRPX100::setValue(&actual_input_rate, pJson["actualInputRate"], "qint32", "");
    
    ::SWGRPX100::setValue(&actual_output_rate, pJson["actualOutputRate"], "qint32", "");
    
    ::SWGRPX100::setValue(&clock_gen_rate, pJson["clockGenRate"], "qint32", "");
