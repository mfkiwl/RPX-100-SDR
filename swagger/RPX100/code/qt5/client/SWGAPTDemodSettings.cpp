...
SWGAPTDemodSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&crop_noise, pJson["cropNoise"], "qint32", "");
    
    ::SWGRPX100::setValue(&denoise, pJson["denoise"], "qint32", "");
    
    ::SWGRPX100::setValue(&linear_equalise, pJson["linearEqualise"], "qint32", "");
    
    ::SWGRPX100::setValue(&histogram_equalise, pJson["histogramEqualise"], "qint32", "");
    
    ::SWGRPX100::setValue(&precipitation_overlay, pJson["precipitationOverlay"], "qint32", "");
    
    ::SWGRPX100::setValue(&flip, pJson["flip"], "qint32", "");
    
    ::SWGRPX100::setValue(&channels, pJson["channels"], "qint32", "");
    
    ::SWGRPX100::setValue(&decode_enabled, pJson["decodeEnabled"], "qint32", "");
    
    ::SWGRPX100::setValue(&auto_save, pJson["autoSave"], "qint32", "");
    
    ::SWGRPX100::setValue(&auto_save_path, pJson["autoSavePath"], "QString", "QString");
    
    ::SWGRPX100::setValue(&auto_save_min_scan_lines, pJson["autoSaveMinScanLines"], "qint32", "");
