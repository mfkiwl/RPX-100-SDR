...
SWGSigMFFileInputActions::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&play_track, pJson["playTrack"], "qint32", "");
    
    ::SWGRPX100::setValue(&play_record, pJson["playRecord"], "qint32", "");
    
    ::SWGRPX100::setValue(&seek_track, pJson["seekTrack"], "qint32", "");
    
    ::SWGRPX100::setValue(&seek_track_millis, pJson["seekTrackMillis"], "qint32", "");
    
    ::SWGRPX100::setValue(&seek_record_millis, pJson["seekRecordMillis"], "qint32", "");
