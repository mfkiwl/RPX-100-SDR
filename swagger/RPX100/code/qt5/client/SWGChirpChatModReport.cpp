...
SWGChirpChatModReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&symbol_time_ms, pJson["symbolTimeMs"], "float", "");
    
    ::SWGrpx-100::setValue(&payload_time_ms, pJson["payloadTimeMs"], "float", "");
    
    ::SWGrpx-100::setValue(&total_time_ms, pJson["totalTimeMs"], "float", "");
