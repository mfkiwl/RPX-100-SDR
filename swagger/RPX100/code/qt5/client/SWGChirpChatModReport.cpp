...
SWGChirpChatModReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&symbol_time_ms, pJson["symbolTimeMs"], "float", "");
    
    ::SWGRPX100::setValue(&payload_time_ms, pJson["payloadTimeMs"], "float", "");
    
    ::SWGRPX100::setValue(&total_time_ms, pJson["totalTimeMs"], "float", "");
