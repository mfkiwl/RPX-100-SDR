...
SWGRigCtlServerSettings::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&enabled, pJson["enabled"], "qint32", "");
    
    ::SWGrpx-100::setValue(&rig_ctl_port, pJson["rigCtlPort"], "qint32", "");
    
    ::SWGrpx-100::setValue(&max_frequency_offset, pJson["maxFrequencyOffset"], "qint32", "");
    
    ::SWGrpx-100::setValue(&device_index, pJson["deviceIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&channel_index, pJson["channelIndex"], "qint32", "");
