...
SWGSatelliteTrackerSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&tles, pJson["tles"], "QList", "QString");
    ::SWGRPX100::setValue(&date_time, pJson["dateTime"], "QString", "QString");
    
    ::SWGRPX100::setValue(&min_aos_elevation, pJson["minAOSElevation"], "qint32", "");
    
    ::SWGRPX100::setValue(&min_pass_elevation, pJson["minPassElevation"], "qint32", "");
    
    ::SWGRPX100::setValue(&rotator_max_azimuth, pJson["rotatorMaxAzimuth"], "qint32", "");
    
    ::SWGRPX100::setValue(&rotator_max_elevation, pJson["rotatorMaxElevation"], "qint32", "");
    
    ::SWGRPX100::setValue(&az_el_units, pJson["azElUnits"], "qint32", "");
    
    ::SWGRPX100::setValue(&ground_track_points, pJson["groundTrackPoints"], "qint32", "");
    
    ::SWGRPX100::setValue(&date_format, pJson["dateFormat"], "QString", "QString");
    
    ::SWGRPX100::setValue(&utc, pJson["utc"], "qint32", "");
    
    ::SWGRPX100::setValue(&update_period, pJson["updatePeriod"], "float", "");
    
    ::SWGRPX100::setValue(&doppler_period, pJson["dopplerPeriod"], "float", "");
    
    ::SWGRPX100::setValue(&prediction_period, pJson["predictionPeriod"], "qint32", "");
    
    ::SWGRPX100::setValue(&pass_start_time, pJson["passStartTime"], "QString", "QString");
    
    ::SWGRPX100::setValue(&pass_finish_time, pJson["passFinishTime"], "QString", "QString");
    
    ::SWGRPX100::setValue(&default_frequency, pJson["defaultFrequency"], "float", "");
    
    ::SWGRPX100::setValue(&draw_on_map, pJson["drawOnMap"], "qint32", "");
    
    ::SWGRPX100::setValue(&auto_target, pJson["autoTarget"], "qint32", "");
    
    ::SWGRPX100::setValue(&aos_speech, pJson["aosSpeech"], "QString", "QString");
    
    ::SWGRPX100::setValue(&los_speech, pJson["losSpeech"], "QString", "QString");
    ...
    ::SWGRPX100::setValue(&device_settings, pJson["deviceSettings"], "QList", "SWGSatelliteDeviceSettingsList");
