...
SWGRange::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&min, pJson["min"], "qint32", "");
    
    ::SWGRPX100::setValue(&max, pJson["max"], "qint32", "");
    
    ::SWGRPX100::setValue(&step, pJson["step"], "qint32", "");
    
    ::SWGRPX100::setValue(&scale, pJson["scale"], "float", "");
