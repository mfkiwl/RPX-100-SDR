...
SWGCapture::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&tsms, pJson["tsms"], "qint64", "");
    
    ::SWGRPX100::setValue(&center_frequency, pJson["centerFrequency"], "qint64", "");
    
    ::SWGRPX100::setValue(&sample_rate, pJson["sampleRate"], "qint32", "");
    
    ::SWGRPX100::setValue(&sample_start, pJson["sampleStart"], "qint64", "");
    
    ::SWGRPX100::setValue(&length, pJson["length"], "qint64", "");
    
    ::SWGRPX100::setValue(&cumulative_time, pJson["cumulativeTime"], "qint64", "");
