...
#ifndef SWGAISSettings_H_
#define SWGAISSettings_H_
...
public:
    SWGAISSettings();
    SWGAISSettings(QString* json);
    virtual ~SWGAISSettings();
    void init();
    void cleanup();
    ...
    virtual SWGAISSettings* fromJson(QString &jsonString) override;
