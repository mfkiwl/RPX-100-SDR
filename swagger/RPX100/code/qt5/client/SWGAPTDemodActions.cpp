...
SWGAPTDemodActions::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&aos, pJson["aos"], "SWGAPTDemodActions_aos", "SWGAPTDemodActions_aos");
    
    ::SWGRPX100::setValue(&los, pJson["los"], "SWGAPTDemodActions_los", "SWGAPTDemodActions_los");
