...
SWGAntennaToolsSettings::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&dipole_frequency_m_hz, pJson["dipoleFrequencyMHz"], "float", "");
    
    ::SWGRPX100::setValue(&dipole_end_effect_factor, pJson["dipoleEndEffectFactor"], "float", "");
    
    ::SWGRPX100::setValue(&dish_frequency_m_hz, pJson["dishFrequencyMHz"], "float", "");
    
    ::SWGRPX100::setValue(&dish_diameter, pJson["dishDiameter"], "float", "");
    
    ::SWGRPX100::setValue(&dish_depth, pJson["dishDepth"], "float", "");
    
    ::SWGRPX100::setValue(&dish_efficiency, pJson["dishEfficiency"], "qint32", "");
