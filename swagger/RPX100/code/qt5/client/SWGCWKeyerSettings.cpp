...
SWGCWKeyerSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&wpm, pJson["wpm"], "qint32", "");
    
    ::SWGRPX100::setValue(&mode, pJson["mode"], "qint32", "");
    
    ::SWGRPX100::setValue(&text, pJson["text"], "QString", "QString");
    
    ::SWGRPX100::setValue(&loop, pJson["loop"], "qint32", "");
    
    ::SWGRPX100::setValue(&keyboard_iambic, pJson["keyboardIambic"], "qint32", "");
    
    ::SWGRPX100::setValue(&dot_key, pJson["dotKey"], "qint32", "");
    
    ::SWGRPX100::setValue(&dot_key_modifiers, pJson["dotKeyModifiers"], "qint32", "");
    
    ::SWGRPX100::setValue(&dash_key, pJson["dashKey"], "qint32", "");
    
    ::SWGRPX100::setValue(&dash_key_modifiers, pJson["dashKeyModifiers"], "qint32", "");
