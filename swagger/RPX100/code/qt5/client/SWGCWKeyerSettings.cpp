...
SWGCWKeyerSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&wpm, pJson["wpm"], "qint32", "");
    
    ::SWGrpx-100::setValue(&mode, pJson["mode"], "qint32", "");
    
    ::SWGrpx-100::setValue(&text, pJson["text"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&loop, pJson["loop"], "qint32", "");
    
    ::SWGrpx-100::setValue(&keyboard_iambic, pJson["keyboardIambic"], "qint32", "");
    
    ::SWGrpx-100::setValue(&dot_key, pJson["dotKey"], "qint32", "");
    
    ::SWGrpx-100::setValue(&dot_key_modifiers, pJson["dotKeyModifiers"], "qint32", "");
    
    ::SWGrpx-100::setValue(&dash_key, pJson["dashKey"], "qint32", "");
    
    ::SWGrpx-100::setValue(&dash_key_modifiers, pJson["dashKeyModifiers"], "qint32", "");
