...
SWGGLSpectrum::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&fft_size, pJson["fftSize"], "qint32", "");
    
    ::SWGRPX100::setValue(&fft_overlap, pJson["fftOverlap"], "qint32", "");
    
    ::SWGRPX100::setValue(&fft_window, pJson["fftWindow"], "qint32", "");
    
    ::SWGRPX100::setValue(&ref_level, pJson["refLevel"], "float", "");
    
    ::SWGRPX100::setValue(&power_range, pJson["powerRange"], "float", "");
    
    ::SWGRPX100::setValue(&fps_period_ms, pJson["fpsPeriodMs"], "qint32", "");
    
    ::SWGRPX100::setValue(&display_waterfall, pJson["displayWaterfall"], "qint32", "");
    
    ::SWGRPX100::setValue(&inverted_waterfall, pJson["invertedWaterfall"], "qint32", "");
    
    ::SWGRPX100::setValue(&display_max_hold, pJson["displayMaxHold"], "qint32", "");
    
    ::SWGRPX100::setValue(&display_histogram, pJson["displayHistogram"], "qint32", "");
    
    ::SWGRPX100::setValue(&decay, pJson["decay"], "qint32", "");
    
    ::SWGRPX100::setValue(&display_grid, pJson["displayGrid"], "qint32", "");
    
    ::SWGRPX100::setValue(&display_grid_intensity, pJson["displayGridIntensity"], "qint32", "");
    
    ::SWGRPX100::setValue(&decay_divisor, pJson["decayDivisor"], "qint32", "");
    
    ::SWGRPX100::setValue(&histogram_stroke, pJson["histogramStroke"], "qint32", "");
    
    ::SWGRPX100::setValue(&display_current, pJson["displayCurrent"], "qint32", "");
    
    ::SWGRPX100::setValue(&display_trace_intensity, pJson["displayTraceIntensity"], "qint32", "");
    
    ::SWGRPX100::setValue(&waterfall_share, pJson["waterfallShare"], "float", "");
    
    ::SWGRPX100::setValue(&averaging_mode, pJson["averagingMode"], "qint32", "");
    
    ::SWGRPX100::setValue(&averaging_value, pJson["averagingValue"], "qint32", "");
    
    ::SWGRPX100::setValue(&linear, pJson["linear"], "qint32", "");
    
    ::SWGRPX100::setValue(&ssb, pJson["ssb"], "qint32", "");
    
    ::SWGRPX100::setValue(&usb, pJson["usb"], "qint32", "");
    
    ::SWGRPX100::setValue(&ws_spectrum_address, pJson["wsSpectrumAddress"], "QString", "QString");
    
    ::SWGRPX100::setValue(&ws_spectrum_port, pJson["wsSpectrumPort"], "qint32", "");
