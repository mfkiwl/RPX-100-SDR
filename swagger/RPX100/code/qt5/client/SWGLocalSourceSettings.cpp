...
SWGLocalSourceSettings::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&local_device_index, pJson["localDeviceIndex"], "qint32", "");
    ...
    ::SWGrpx-100::setValue(&filter_chain_hash, pJson["filterChainHash"], "qint32", "");
    
    ::SWGrpx-100::setValue(&play, pJson["play"], "qint32", "");
