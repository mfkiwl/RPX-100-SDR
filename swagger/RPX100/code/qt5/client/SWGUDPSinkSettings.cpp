...
SWGUDPSinkSettings::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&output_sample_rate, pJson["outputSampleRate"], "float", "");
    ...
    ::SWGrpx-100::setValue(&squelch_db, pJson["squelchDB"], "qint32", "");
    ...
    ::SWGrpx-100::setValue(&audio_active, pJson["audioActive"], "qint32", "");
    
    ::SWGrpx-100::setValue(&audio_stereo, pJson["audioStereo"], "qint32", "");
    
    ::SWGrpx-100::setValue(&volume, pJson["volume"], "qint32", "");
    
    ::SWGrpx-100::setValue(&udp_address, pJson["udpAddress"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&udp_port, pJson["udpPort"], "qint32", "");
    
    ::SWGrpx-100::setValue(&audio_port, pJson["audioPort"], "qint32", "");
