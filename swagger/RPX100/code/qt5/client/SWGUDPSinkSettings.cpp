...
SWGUDPSinkSettings::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&output_sample_rate, pJson["outputSampleRate"], "float", "");
    ...
    ::SWGRPX100::setValue(&squelch_db, pJson["squelchDB"], "qint32", "");
    ...
    ::SWGRPX100::setValue(&audio_active, pJson["audioActive"], "qint32", "");
    
    ::SWGRPX100::setValue(&audio_stereo, pJson["audioStereo"], "qint32", "");
    
    ::SWGRPX100::setValue(&volume, pJson["volume"], "qint32", "");
    
    ::SWGRPX100::setValue(&udp_address, pJson["udpAddress"], "QString", "QString");
    
    ::SWGRPX100::setValue(&udp_port, pJson["udpPort"], "qint32", "");
    
    ::SWGRPX100::setValue(&audio_port, pJson["audioPort"], "qint32", "");
