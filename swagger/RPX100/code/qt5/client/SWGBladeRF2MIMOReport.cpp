...
SWGBladeRF2MIMOReport::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&frequency_range_rx, pJson["frequencyRangeRx"], "SWGFrequencyRange", "SWGFrequencyRange");
    
    ::SWGRPX100::setValue(&sample_rate_range_rx, pJson["sampleRateRangeRx"], "SWGRange", "SWGRange");
    
    ::SWGRPX100::setValue(&bandwidth_range_rx, pJson["bandwidthRangeRx"], "SWGRange", "SWGRange");
    
    ::SWGRPX100::setValue(&global_gain_range_rx, pJson["globalGainRangeRx"], "SWGRange", "SWGRange");
    
    
    ::SWGRPX100::setValue(&gain_modes_rx, pJson["gainModesRx"], "QList", "SWGNamedEnum");
    ::SWGRPX100::setValue(&frequency_range_tx, pJson["frequencyRangeTx"], "SWGFrequencyRange", "SWGFrequencyRange");
    
    ::SWGRPX100::setValue(&sample_rate_range_tx, pJson["sampleRateRangeTx"], "SWGRange", "SWGRange");
    
    ::SWGRPX100::setValue(&bandwidth_range_tx, pJson["bandwidthRangeTx"], "SWGRange", "SWGRange");
    
    ::SWGRPX100::setValue(&global_gain_range_tx, pJson["globalGainRangeTx"], "SWGRange", "SWGRange");
