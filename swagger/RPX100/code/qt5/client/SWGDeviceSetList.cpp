...
SWGDeviceSetList::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&devicesetcount, pJson["devicesetcount"], "qint32", "");
    
    ::SWGRPX100::setValue(&devicesetfocus, pJson["devicesetfocus"], "qint32", "");
    
    
    ::SWGRPX100::setValue(&device_sets, pJson["deviceSets"], "QList", "SWGDeviceSet");
}
