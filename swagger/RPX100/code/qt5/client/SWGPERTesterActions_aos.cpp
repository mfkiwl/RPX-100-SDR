...
SWGPERTesterActions_aos::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&satellite_name, pJson["satelliteName"], "QString", "QString");
    
    ::SWGRPX100::setValue(&aos_time, pJson["aosTime"], "QString", "QString");
    
    ::SWGRPX100::setValue(&los_time, pJson["losTime"], "QString", "QString");
