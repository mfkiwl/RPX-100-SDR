...
SWGBFMDemodReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&pilot_locked, pJson["pilotLocked"], "qint32", "");
    
    ::SWGRPX100::setValue(&pilot_power_db, pJson["pilotPowerDB"], "float", "");
    
    ::SWGRPX100::setValue(&rds_report, pJson["rdsReport"], "SWGRDSReport", "SWGRDSReport");
