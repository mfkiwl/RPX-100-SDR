...
SWGDeviceConfig::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&device_id, pJson["deviceId"], "QString", "QString");
    
    ::SWGRPX100::setValue(&device_serial, pJson["deviceSerial"], "QString", "QString");
    
    ::SWGRPX100::setValue(&device_sequence, pJson["deviceSequence"], "qint32", "");
    
    ::SWGRPX100::setValue(&config, pJson["config"], "SWGDeviceSettings", "SWGDeviceSettings");
