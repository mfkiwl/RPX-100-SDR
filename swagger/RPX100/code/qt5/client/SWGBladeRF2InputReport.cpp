...
SWGBladeRF2InputReport::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&frequency_range, pJson["frequencyRange"], "SWGFrequencyRange", "SWGFrequencyRange");
    
    ::SWGRPX100::setValue(&sample_rate_range, pJson["sampleRateRange"], "SWGRange", "SWGRange");
    
    ::SWGRPX100::setValue(&bandwidth_range, pJson["bandwidthRange"], "SWGRange", "SWGRange");
    
    ::SWGRPX100::setValue(&global_gain_range, pJson["globalGainRange"], "SWGRange", "SWGRange");
    
    
    ::SWGRPX100::setValue(&gain_modes, pJson["gainModes"], "QList", "SWGNamedEnum");
}
