...
SWGAirspyHFSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&agc_high, pJson["agcHigh"], "qint32", "");
    
    ::SWGRPX100::setValue(&use_dsp, pJson["useDSP"], "qint32", "");
    
    ::SWGRPX100::setValue(&use_lna, pJson["useLNA"], "qint32", "");
    
    ::SWGRPX100::setValue(&attenuator_steps, pJson["attenuatorSteps"], "qint32", "");
