...
SWGBFMDemodSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&lsb_stereo, pJson["lsbStereo"], "qint32", "");
    
    ::SWGRPX100::setValue(&show_pilot, pJson["showPilot"], "qint32", "");
    
    ::SWGRPX100::setValue(&rds_active, pJson["rdsActive"], "qint32", "");
