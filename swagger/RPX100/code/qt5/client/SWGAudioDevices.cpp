...
SWGAudioDevices::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&nb_input_devices, pJson["nbInputDevices"], "qint32", "");
    
    
    ::SWGrpx-100::setValue(&input_devices, pJson["inputDevices"], "QList", "SWGAudioInputDevice");
    ::SWGrpx-100::setValue(&nb_output_devices, pJson["nbOutputDevices"], "qint32", "");
    
    
    ::SWGrpx-100::setValue(&output_devices, pJson["outputDevices"], "QList", "SWGAudioOutputDevice");
}
