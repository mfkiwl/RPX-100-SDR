...
SWGAudioDevices::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&nb_input_devices, pJson["nbInputDevices"], "qint32", "");
    
    
    ::SWGRPX100::setValue(&input_devices, pJson["inputDevices"], "QList", "SWGAudioInputDevice");
    ::SWGRPX100::setValue(&nb_output_devices, pJson["nbOutputDevices"], "qint32", "");
    
    
    ::SWGRPX100::setValue(&output_devices, pJson["outputDevices"], "QList", "SWGAudioOutputDevice");
}
