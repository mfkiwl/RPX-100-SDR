...
SWGChannelAnalyzerSettings::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&frequency, pJson["frequency"], "qint32", "");
    
    ::SWGRPX100::setValue(&down_sample, pJson["downSample"], "qint32", "");
    
    ::SWGRPX100::setValue(&down_sample_rate, pJson["downSampleRate"], "qint32", "");
    
    ::SWGRPX100::setValue(&bandwidth, pJson["bandwidth"], "qint32", "");
    
    ::SWGRPX100::setValue(&low_cutoff, pJson["lowCutoff"], "qint32", "");
    
    ::SWGRPX100::setValue(&span_log2, pJson["spanLog2"], "qint32", "");
    
    ::SWGRPX100::setValue(&ssb, pJson["ssb"], "qint32", "");
    
    ::SWGRPX100::setValue(&pll, pJson["pll"], "qint32", "");
    
    ::SWGRPX100::setValue(&fll, pJson["fll"], "qint32", "");
    
    ::SWGRPX100::setValue(&costas_loop, pJson["costasLoop"], "qint32", "");
    ...
    ::SWGRPX100::setValue(&pll_bandwidth, pJson["pllBandwidth"], "float", "");
    
    ::SWGRPX100::setValue(&pll_damping_factor, pJson["pllDampingFactor"], "float", "");
    
    ::SWGRPX100::setValue(&pll_loop_gain, pJson["pllLoopGain"], "float", "");
    
    ::SWGRPX100::setValue(&input_type, pJson["inputType"], "qint32", "");
