...
SWGCommand::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&command, pJson["command"], "QString", "QString");
    
    ::SWGRPX100::setValue(&arg_string, pJson["argString"], "QString", "QString");
    
    ::SWGRPX100::setValue(&key, pJson["key"], "qint32", "");
    
    ::SWGRPX100::setValue(&key_modifiers, pJson["keyModifiers"], "qint32", "");
    
    ::SWGRPX100::setValue(&associate_key, pJson["associateKey"], "qint32", "");
    
    ::SWGRPX100::setValue(&release, pJson["release"], "qint32", "");
