...
SWGLimeRFESettings::fromJsonObject(QJsonObject &pJson) {
    ::SWGRPX100::setValue(&device_path, pJson["devicePath"], "QString", "QString");
    
    ::SWGRPX100::setValue(&rx_channels, pJson["rxChannels"], "qint32", "");
    
    ::SWGRPX100::setValue(&rx_wideband_channel, pJson["rxWidebandChannel"], "qint32", "");
    
    ::SWGRPX100::setValue(&rx_ham_channel, pJson["rxHAMChannel"], "qint32", "");
    
    ::SWGRPX100::setValue(&rx_cellular_channel, pJson["rxCellularChannel"], "qint32", "");
    
    ::SWGRPX100::setValue(&rx_port, pJson["rxPort"], "qint32", "");
    
    ::SWGRPX100::setValue(&attenuation_factor, pJson["attenuationFactor"], "qint32", "");
    
    ::SWGRPX100::setValue(&amfm_notch, pJson["amfmNotch"], "qint32", "");
    
    ::SWGRPX100::setValue(&tx_channels, pJson["txChannels"], "qint32", "");
    
    ::SWGRPX100::setValue(&tx_wideband_channel, pJson["txWidebandChannel"], "qint32", "");
    
    ::SWGRPX100::setValue(&tx_ham_channel, pJson["txHAMChannel"], "qint32", "");
    
    ::SWGRPX100::setValue(&tx_cellular_channel, pJson["txCellularChannel"], "qint32", "");
    
    ::SWGRPX100::setValue(&tx_port, pJson["txPort"], "qint32", "");
    
    ::SWGRPX100::setValue(&swr_enable, pJson["swrEnable"], "qint32", "");
    
    ::SWGRPX100::setValue(&swr_source, pJson["swrSource"], "qint32", "");
    
    ::SWGRPX100::setValue(&rx_on, pJson["rxOn"], "qint32", "");
    
    ::SWGRPX100::setValue(&tx_on, pJson["txOn"], "qint32", "");
