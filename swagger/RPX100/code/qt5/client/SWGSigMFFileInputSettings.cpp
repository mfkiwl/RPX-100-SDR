...
SWGSigMFFileInputSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&acceleration_factor, pJson["accelerationFactor"], "qint32", "");
    
    ::SWGRPX100::setValue(&track_loop, pJson["trackLoop"], "qint32", "");
    
    ::SWGRPX100::setValue(&full_loop, pJson["fullLoop"], "qint32", "");
