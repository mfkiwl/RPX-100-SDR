...
SWGRemoteInputReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&buffer_rw_balance, pJson["bufferRWBalance"], "qint32", "");
    
    ::SWGrpx-100::setValue(&remote_timestamp, pJson["remoteTimestamp"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&min_nb_blocks, pJson["minNbBlocks"], "qint32", "");
    
    ::SWGrpx-100::setValue(&max_nb_recovery, pJson["maxNbRecovery"], "qint32", "");
