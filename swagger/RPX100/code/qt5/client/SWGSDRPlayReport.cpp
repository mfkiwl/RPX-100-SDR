...
SWGSDRPlayReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&sample_rates, pJson["sampleRates"], "QList", "SWGSampleRate");
    
    ::SWGRPX100::setValue(&bandwidths, pJson["bandwidths"], "QList", "SWGBandwidth");
    
    ::SWGRPX100::setValue(&intermediate_frequencies, pJson["intermediateFrequencies"], "QList", "SWGFrequency");
    
    ::SWGRPX100::setValue(&frequency_bands, pJson["frequencyBands"], "QList", "SWGFrequencyBand");
}
