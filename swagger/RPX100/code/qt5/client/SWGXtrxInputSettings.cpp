...
SWGXtrxInputSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGRPX100::setValue(&nco_enable, pJson["ncoEnable"], "qint32", "");
    
    ::SWGRPX100::setValue(&nco_frequency, pJson["ncoFrequency"], "qint32", "");
    ...
    ::SWGRPX100::setValue(&tia_gain, pJson["tiaGain"], "qint32", "");
    
    ::SWGRPX100::setValue(&pga_gain, pJson["pgaGain"], "qint32", "");
    
    ::SWGRPX100::setValue(&ext_clock, pJson["extClock"], "qint32", "");
    
    ::SWGRPX100::setValue(&ext_clock_freq, pJson["extClockFreq"], "qint32", "");
    
    ::SWGRPX100::setValue(&pwrmode, pJson["pwrmode"], "qint32", "");
