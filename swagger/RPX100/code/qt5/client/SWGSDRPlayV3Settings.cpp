...
SWGSDRPlayV3Settings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&if_frequency_index, pJson["ifFrequencyIndex"], "qint32", "");
    ...
    ::SWGrpx-100::setValue(&lna_index, pJson["lnaIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&if_agc, pJson["ifAGC"], "qint32", "");
    
    ::SWGrpx-100::setValue(&if_gain, pJson["ifGain"], "qint32", "");
    
    ::SWGrpx-100::setValue(&am_notch, pJson["amNotch"], "qint32", "");
    
    ::SWGrpx-100::setValue(&fm_notch, pJson["fmNotch"], "qint32", "");
    
    ::SWGrpx-100::setValue(&dab_notch, pJson["dabNotch"], "qint32", "");
    
    ::SWGrpx-100::setValue(&ext_ref, pJson["extRef"], "qint32", "");
    
    ::SWGrpx-100::setValue(&tuner, pJson["tuner"], "qint32", "");
    
    ::SWGrpx-100::setValue(&antenna, pJson["antenna"], "qint32", "");
