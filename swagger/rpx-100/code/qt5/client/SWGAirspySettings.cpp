...
SWGAirspySettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&mixer_gain, pJson["mixerGain"], "qint32", "");
    
    ::SWGrpx-100::setValue(&vga_gain, pJson["vgaGain"], "qint32", "");
    
    ::SWGrpx-100::setValue(&lna_agc, pJson["lnaAGC"], "qint32", "");
    
    ::SWGrpx-100::setValue(&mixer_agc, pJson["mixerAGC"], "qint32", "");
