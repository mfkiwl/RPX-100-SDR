...
SWGAPTDemodActions::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&aos, pJson["aos"], "SWGAPTDemodActions_aos", "SWGAPTDemodActions_aos");
    
    ::SWGrpx-100::setValue(&los, pJson["los"], "SWGAPTDemodActions_los", "SWGAPTDemodActions_los");
