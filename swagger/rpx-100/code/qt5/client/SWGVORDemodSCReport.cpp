...
SWGVORDemodSCReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&nav_id, pJson["navId"], "qint32", "");
    
    ::SWGrpx-100::setValue(&radial, pJson["radial"], "float", "");
    
    ::SWGrpx-100::setValue(&ref_mag, pJson["refMag"], "float", "");
    
    ::SWGrpx-100::setValue(&var_mag, pJson["varMag"], "float", "");
    
    ::SWGrpx-100::setValue(&valid_radial, pJson["validRadial"], "qint32", "");
    
    ::SWGrpx-100::setValue(&valid_ref_mag, pJson["validRefMag"], "qint32", "");
    
    ::SWGrpx-100::setValue(&valid_var_mag, pJson["validVarMag"], "qint32", "");
    
    ::SWGrpx-100::setValue(&morse_ident, pJson["morseIdent"], "QString", "QString");
