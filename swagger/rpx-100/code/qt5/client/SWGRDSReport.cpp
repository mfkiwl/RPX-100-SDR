...
SWGRDSReport::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&demod_status, pJson["demodStatus"], "qint32", "");
    
    ::SWGrpx-100::setValue(&decod_status, pJson["decodStatus"], "qint32", "");
    
    ::SWGrpx-100::setValue(&rds_demod_accum_db, pJson["rdsDemodAccumDB"], "float", "");
    
    ::SWGrpx-100::setValue(&rds_demod_frequency, pJson["rdsDemodFrequency"], "float", "");
    
    ::SWGrpx-100::setValue(&pid, pJson["pid"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&pi_type, pJson["piType"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&pi_coverage, pJson["piCoverage"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&prog_service_name, pJson["progServiceName"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&music_speech, pJson["musicSpeech"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&mono_stereo, pJson["monoStereo"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&radio_text, pJson["radioText"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&time, pJson["time"], "QString", "QString");
    
    
    ::SWGrpx-100::setValue(&alt_frequencies, pJson["altFrequencies"], "QList", "SWGRDSReport_altFrequencies");
}
