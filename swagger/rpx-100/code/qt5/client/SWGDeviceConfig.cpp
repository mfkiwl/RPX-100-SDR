...
SWGDeviceConfig::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&device_id, pJson["deviceId"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&device_serial, pJson["deviceSerial"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&device_sequence, pJson["deviceSequence"], "qint32", "");
    
    ::SWGrpx-100::setValue(&config, pJson["config"], "SWGDeviceSettings", "SWGDeviceSettings");
