...
SWGInstanceSummaryResponse::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&version, pJson["version"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&qt_version, pJson["qtVersion"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&dsp_rx_bits, pJson["dspRxBits"], "qint32", "");
    
    ::SWGrpx-100::setValue(&dsp_tx_bits, pJson["dspTxBits"], "qint32", "");
    
    ::SWGrpx-100::setValue(&pid, pJson["pid"], "qint32", "");
    
    ::SWGrpx-100::setValue(&appname, pJson["appname"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&architecture, pJson["architecture"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&os, pJson["os"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&logging, pJson["logging"], "SWGLoggingInfo", "SWGLoggingInfo");
    
    ::SWGrpx-100::setValue(&devicesetlist, pJson["devicesetlist"], "SWGDeviceSetList", "SWGDeviceSetList");
    
    ::SWGrpx-100::setValue(&featuresetlist, pJson["featuresetlist"], "SWGFeatureSetList", "SWGFeatureSetList");
