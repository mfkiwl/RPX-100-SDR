...
SWGBFMDemodSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&lsb_stereo, pJson["lsbStereo"], "qint32", "");
    
    ::SWGrpx-100::setValue(&show_pilot, pJson["showPilot"], "qint32", "");
    
    ::SWGrpx-100::setValue(&rds_active, pJson["rdsActive"], "qint32", "");
