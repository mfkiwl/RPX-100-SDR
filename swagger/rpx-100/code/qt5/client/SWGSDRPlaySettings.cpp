...
SWGSDRPlaySettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&tuner_gain, pJson["tunerGain"], "qint32", "");
    
    ::SWGrpx-100::setValue(&l_oppm_tenths, pJson["LOppmTenths"], "qint32", "");
    
    ::SWGrpx-100::setValue(&frequency_band_index, pJson["frequencyBandIndex"], "qint32", "");
    ...
    ::SWGrpx-100::setValue(&tuner_gain_mode, pJson["tunerGainMode"], "qint32", "");
    
    ::SWGrpx-100::setValue(&lna_on, pJson["lnaOn"], "qint32", "");
    
    ::SWGrpx-100::setValue(&mixer_amp_on, pJson["mixerAmpOn"], "qint32", "");
    
    ::SWGrpx-100::setValue(&baseband_gain, pJson["basebandGain"], "qint32", "");
