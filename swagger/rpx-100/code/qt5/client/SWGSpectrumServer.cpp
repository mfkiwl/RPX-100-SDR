...
SWGSpectrumServer::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&run, pJson["run"], "qint32", "");
    
    ::SWGrpx-100::setValue(&listening_address, pJson["listeningAddress"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&listening_port, pJson["listeningPort"], "qint32", "");
    
    
    ::SWGrpx-100::setValue(&clients, pJson["clients"], "QList", "SWGSpectrumServer_clients");
}
