 ...
 *
 * A named gain setting specified by its range
 */

#ifndef SWGSoapySDRGainSetting_H_
#define SWGSoapySDRGainSetting_H_
...
class SWG_API SWGSoapySDRGainSetting: public SWGObject {
public:
...
#endif /* SWGSoapySDRGainSetting_H_ */
