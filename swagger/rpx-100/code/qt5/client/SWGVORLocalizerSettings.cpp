...
SWGVORLocalizerSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&mag_dec_adjust, pJson["magDecAdjust"], "qint32", "");
    
    ::SWGrpx-100::setValue(&rr_time, pJson["rrTime"], "qint32", "");
    
    ::SWGrpx-100::setValue(&force_rr_averaging, pJson["forceRRAveraging"], "qint32", "");
    
    ::SWGrpx-100::setValue(&center_shift, pJson["centerShift"], "qint32", "");
