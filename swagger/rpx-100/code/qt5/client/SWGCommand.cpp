...
SWGCommand::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&command, pJson["command"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&arg_string, pJson["argString"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&key, pJson["key"], "qint32", "");
    
    ::SWGrpx-100::setValue(&key_modifiers, pJson["keyModifiers"], "qint32", "");
    
    ::SWGrpx-100::setValue(&associate_key, pJson["associateKey"], "qint32", "");
    
    ::SWGrpx-100::setValue(&release, pJson["release"], "qint32", "");
