...
SWGDeviceSet::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&sampling_device, pJson["samplingDevice"], "SWGSamplingDevice", "SWGSamplingDevice");
    
    ::SWGrpx-100::setValue(&channelcount, pJson["channelcount"], "qint32", "");
    
    
    ::SWGrpx-100::setValue(&channels, pJson["channels"], "QList", "SWGChannel");
}
