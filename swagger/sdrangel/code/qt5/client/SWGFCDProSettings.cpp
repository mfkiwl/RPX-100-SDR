...
SWGFCDProSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&lna_gain_index, pJson["lnaGainIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&rf_filter_index, pJson["rfFilterIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&lna_enhance_index, pJson["lnaEnhanceIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&band_index, pJson["bandIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&mixer_gain_index, pJson["mixerGainIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&mixer_filter_index, pJson["mixerFilterIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&bias_current_index, pJson["biasCurrentIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&mode_index, pJson["modeIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&gain1_index, pJson["gain1Index"], "qint32", "");
    
    ::SWGrpx-100::setValue(&rc_filter_index, pJson["rcFilterIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&gain2_index, pJson["gain2Index"], "qint32", "");
    
    ::SWGrpx-100::setValue(&gain3_index, pJson["gain3Index"], "qint32", "");
    
    ::SWGrpx-100::setValue(&gain4_index, pJson["gain4Index"], "qint32", "");
    
    ::SWGrpx-100::setValue(&if_filter_index, pJson["ifFilterIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&gain5_index, pJson["gain5Index"], "qint32", "");
    
    ::SWGrpx-100::setValue(&gain6_index, pJson["gain6Index"], "qint32", "");
