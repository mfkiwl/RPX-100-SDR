...
SWGBladeRF2MIMOSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&rx_bandwidth, pJson["rxBandwidth"], "qint32", "");
    
    ::SWGrpx-100::setValue(&rx0_gain_mode, pJson["rx0GainMode"], "qint32", "");
    
    ::SWGrpx-100::setValue(&rx0_global_gain, pJson["rx0GlobalGain"], "qint32", "");
    
    ::SWGrpx-100::setValue(&rx1_gain_mode, pJson["rx1GainMode"], "qint32", "");
    
    ::SWGrpx-100::setValue(&rx1_global_gain, pJson["rx1GlobalGain"], "qint32", "");
    
    ::SWGrpx-100::setValue(&rx_bias_tee, pJson["rxBiasTee"], "qint32", "");
    ...
    ::SWGrpx-100::setValue(&tx_bandwidth, pJson["txBandwidth"], "qint32", "");
    
    ::SWGrpx-100::setValue(&tx0_global_gain, pJson["tx0GlobalGain"], "qint32", "");
    
    ::SWGrpx-100::setValue(&tx1_global_gain, pJson["tx1GlobalGain"], "qint32", "");
    
    ::SWGrpx-100::setValue(&tx_bias_tee, pJson["txBiasTee"], "qint32", "");
