...
SWGAFCReport::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&tracker_channel_index, pJson["trackerChannelIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&tracker_device_frequency, pJson["trackerDeviceFrequency"], "qint64", "");
    
    ::SWGrpx-100::setValue(&tracker_channel_offset, pJson["trackerChannelOffset"], "qint32", "");
