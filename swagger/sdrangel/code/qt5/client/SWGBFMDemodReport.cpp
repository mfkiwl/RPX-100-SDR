...
SWGBFMDemodReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&pilot_locked, pJson["pilotLocked"], "qint32", "");
    
    ::SWGrpx-100::setValue(&pilot_power_db, pJson["pilotPowerDB"], "float", "");
    
    ::SWGrpx-100::setValue(&rds_report, pJson["rdsReport"], "SWGRDSReport", "SWGRDSReport");
