...
SWGBladeRF2MIMOReport::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&frequency_range_rx, pJson["frequencyRangeRx"], "SWGFrequencyRange", "SWGFrequencyRange");
    
    ::SWGrpx-100::setValue(&sample_rate_range_rx, pJson["sampleRateRangeRx"], "SWGRange", "SWGRange");
    
    ::SWGrpx-100::setValue(&bandwidth_range_rx, pJson["bandwidthRangeRx"], "SWGRange", "SWGRange");
    
    ::SWGrpx-100::setValue(&global_gain_range_rx, pJson["globalGainRangeRx"], "SWGRange", "SWGRange");
    
    
    ::SWGrpx-100::setValue(&gain_modes_rx, pJson["gainModesRx"], "QList", "SWGNamedEnum");
    ::SWGrpx-100::setValue(&frequency_range_tx, pJson["frequencyRangeTx"], "SWGFrequencyRange", "SWGFrequencyRange");
    
    ::SWGrpx-100::setValue(&sample_rate_range_tx, pJson["sampleRateRangeTx"], "SWGRange", "SWGRange");
    
    ::SWGrpx-100::setValue(&bandwidth_range_tx, pJson["bandwidthRangeTx"], "SWGRange", "SWGRange");
    
    ::SWGrpx-100::setValue(&global_gain_range_tx, pJson["globalGainRangeTx"], "SWGRange", "SWGRange");
