...
SWGXtrxMIMOReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&gps_lock, pJson["gpsLock"], "qint32", "");
    
    ::SWGrpx-100::setValue(&actual_input_rate, pJson["actualInputRate"], "qint32", "");
    
    ::SWGrpx-100::setValue(&actual_output_rate, pJson["actualOutputRate"], "qint32", "");
    
    ::SWGrpx-100::setValue(&clock_gen_rate, pJson["clockGenRate"], "qint32", "");
