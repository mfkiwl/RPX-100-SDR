...
SWGDeviceSetList::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&devicesetcount, pJson["devicesetcount"], "qint32", "");
    
    ::SWGrpx-100::setValue(&devicesetfocus, pJson["devicesetfocus"], "qint32", "");
    
    
    ::SWGrpx-100::setValue(&device_sets, pJson["deviceSets"], "QList", "SWGDeviceSet");
}
