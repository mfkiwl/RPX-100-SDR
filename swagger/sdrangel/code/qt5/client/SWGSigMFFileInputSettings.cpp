...
SWGSigMFFileInputSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&acceleration_factor, pJson["accelerationFactor"], "qint32", "");
    
    ::SWGrpx-100::setValue(&track_loop, pJson["trackLoop"], "qint32", "");
    
    ::SWGrpx-100::setValue(&full_loop, pJson["fullLoop"], "qint32", "");
