...
SWGSatelliteDeviceSettings::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&device_set, pJson["deviceSet"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&preset_group, pJson["presetGroup"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&preset_frequency, pJson["presetFrequency"], "qint64", "");
    
    ::SWGrpx-100::setValue(&preset_description, pJson["presetDescription"], "QString", "QString");
    
    
    ::SWGrpx-100::setValue(&doppler, pJson["doppler"], "QList", "qint32");
    ::SWGrpx-100::setValue(&start_on_aos, pJson["startOnAOS"], "qint32", "");
    
    ::SWGrpx-100::setValue(&stop_on_los, pJson["stopOnLOS"], "qint32", "");
    
    ::SWGrpx-100::setValue(&start_stop_file_sinks, pJson["startStopFileSinks"], "qint32", "");
    
    ::SWGrpx-100::setValue(&frequency, pJson["frequency"], "qint64", "");
