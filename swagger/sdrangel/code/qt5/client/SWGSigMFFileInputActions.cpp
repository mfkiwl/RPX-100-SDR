...
SWGSigMFFileInputActions::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&play_track, pJson["playTrack"], "qint32", "");
    
    ::SWGrpx-100::setValue(&play_record, pJson["playRecord"], "qint32", "");
    
    ::SWGrpx-100::setValue(&seek_track, pJson["seekTrack"], "qint32", "");
    
    ::SWGrpx-100::setValue(&seek_track_millis, pJson["seekTrackMillis"], "qint32", "");
    
    ::SWGrpx-100::setValue(&seek_record_millis, pJson["seekRecordMillis"], "qint32", "");
