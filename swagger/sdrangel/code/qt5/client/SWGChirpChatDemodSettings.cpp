...
SWGChirpChatDemodSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&decode_active, pJson["decodeActive"], "qint32", "");
    
    ::SWGrpx-100::setValue(&eom_squelch_tenths, pJson["eomSquelchTenths"], "qint32", "");
    
    ::SWGrpx-100::setValue(&nb_symbols_max, pJson["nbSymbolsMax"], "qint32", "");
    
    ::SWGrpx-100::setValue(&auto_nb_symbols_max, pJson["autoNbSymbolsMax"], "qint32", "");
    ...
    ::SWGrpx-100::setValue(&send_via_udp, pJson["sendViaUDP"], "qint32", "");
