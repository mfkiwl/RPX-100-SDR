...
SWGSoapySDRReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&device_settings_args, pJson["deviceSettingsArgs"], "QList", "SWGArgInfo");
    
    ::SWGrpx-100::setValue(&stream_settings_args, pJson["streamSettingsArgs"], "QList", "SWGArgInfo");
    ::SWGrpx-100::setValue(&has_dc_auto_correction, pJson["hasDCAutoCorrection"], "qint32", "");
    
    ::SWGrpx-100::setValue(&has_dc_offset_value, pJson["hasDCOffsetValue"], "qint32", "");
    
    ::SWGrpx-100::setValue(&has_iq_balance_value, pJson["hasIQBalanceValue"], "qint32", "");
    
    ::SWGrpx-100::setValue(&has_frequency_correction_value, pJson["hasFrequencyCorrectionValue"], "qint32", "");
    
    
    ::SWGrpx-100::setValue(&antennas, pJson["antennas"], "QList", "QString");
    ::SWGrpx-100::setValue(&has_agc, pJson["hasAGC"], "qint32", "");
    
    ::SWGrpx-100::setValue(&gain_range, pJson["gainRange"], "SWGRangeFloat", "SWGRangeFloat");
    
    
    ::SWGrpx-100::setValue(&gain_settings, pJson["gainSettings"], "QList", "SWGSoapySDRGainSetting");
    
    ::SWGrpx-100::setValue(&frequency_settings, pJson["frequencySettings"], "QList", "SWGSoapySDRFrequencySetting");
    
    ::SWGrpx-100::setValue(&frequency_settings_args, pJson["frequencySettingsArgs"], "QList", "SWGArgInfo");
    
    ::SWGrpx-100::setValue(&rates_ranges, pJson["ratesRanges"], "QList", "SWGRangeFloat");
    
    ::SWGrpx-100::setValue(&bandwidths_ranges, pJson["bandwidthsRanges"], "QList", "SWGRangeFloat");
}
