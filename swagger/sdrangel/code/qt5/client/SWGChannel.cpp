...
SWGChannel::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&id, pJson["id"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&uid, pJson["uid"], "qint64", "");
    
    ::SWGrpx-100::setValue(&title, pJson["title"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&delta_frequency, pJson["deltaFrequency"], "qint32", "");
    
    ::SWGrpx-100::setValue(&report, pJson["report"], "SWGChannelReport", "SWGChannelReport");
