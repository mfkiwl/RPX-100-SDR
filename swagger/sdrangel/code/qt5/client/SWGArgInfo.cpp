...
SWGArgInfo::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&key, pJson["key"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&value_type, pJson["valueType"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&value_string, pJson["valueString"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&name, pJson["name"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&description, pJson["description"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&units, pJson["units"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&range, pJson["range"], "SWGRangeFloat", "SWGRangeFloat");
    
    
    ::SWGrpx-100::setValue(&value_options, pJson["valueOptions"], "QList", "QString");
    
    ::SWGrpx-100::setValue(&option_names, pJson["optionNames"], "QList", "QString");
}
