...
SWGPlutoSdrMIMOReport::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&adc_rate, pJson["adcRate"], "qint32", "");
    
    ::SWGrpx-100::setValue(&dac_rate, pJson["dacRate"], "qint32", "");
    
    ::SWGrpx-100::setValue(&rx0_gain_db, pJson["rx0GainDB"], "qint32", "");
    
    ::SWGrpx-100::setValue(&rx1_gain_db, pJson["rx1GainDB"], "qint32", "");
    
    ::SWGrpx-100::setValue(&rssi_rx0, pJson["rssiRx0"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&rssi_rx1, pJson["rssiRx1"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&rssi_tx0, pJson["rssiTx0"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&rssi_tx1, pJson["rssiTx1"], "QString", "QString");
