...
SWGAntennaToolsSettings::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&dipole_frequency_m_hz, pJson["dipoleFrequencyMHz"], "float", "");
    
    ::SWGrpx-100::setValue(&dipole_end_effect_factor, pJson["dipoleEndEffectFactor"], "float", "");
    
    ::SWGrpx-100::setValue(&dish_frequency_m_hz, pJson["dishFrequencyMHz"], "float", "");
    
    ::SWGrpx-100::setValue(&dish_diameter, pJson["dishDiameter"], "float", "");
    
    ::SWGrpx-100::setValue(&dish_depth, pJson["dishDepth"], "float", "");
    
    ::SWGrpx-100::setValue(&dish_efficiency, pJson["dishEfficiency"], "qint32", "");
