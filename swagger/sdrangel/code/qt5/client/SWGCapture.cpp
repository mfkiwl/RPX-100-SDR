...
SWGCapture::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&tsms, pJson["tsms"], "qint64", "");
    
    ::SWGrpx-100::setValue(&center_frequency, pJson["centerFrequency"], "qint64", "");
    
    ::SWGrpx-100::setValue(&sample_rate, pJson["sampleRate"], "qint32", "");
    
    ::SWGrpx-100::setValue(&sample_start, pJson["sampleStart"], "qint64", "");
    
    ::SWGrpx-100::setValue(&length, pJson["length"], "qint64", "");
    
    ::SWGrpx-100::setValue(&cumulative_time, pJson["cumulativeTime"], "qint64", "");
