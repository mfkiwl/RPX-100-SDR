...
SWGSamplingDevice::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&hw_type, pJson["hwType"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&direction, pJson["direction"], "qint32", "");
    
    ::SWGrpx-100::setValue(&device_nb_streams, pJson["deviceNbStreams"], "qint32", "");
    
    ::SWGrpx-100::setValue(&device_stream_index, pJson["deviceStreamIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&sequence, pJson["sequence"], "qint32", "");
    
    ::SWGrpx-100::setValue(&serial, pJson["serial"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&center_frequency, pJson["centerFrequency"], "qint64", "");
    
    ::SWGrpx-100::setValue(&bandwidth, pJson["bandwidth"], "qint32", "");
    
    ::SWGrpx-100::setValue(&state, pJson["state"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&state_rx, pJson["stateRx"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&state_tx, pJson["stateTx"], "QString", "QString");
