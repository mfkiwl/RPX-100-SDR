...
SWGNFMModSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&af_bandwidth, pJson["afBandwidth"], "float", "");
    ...
    ::SWGrpx-100::setValue(&ctcss_on, pJson["ctcssOn"], "qint32", "");
    
    ::SWGrpx-100::setValue(&ctcss_index, pJson["ctcssIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&dcs_on, pJson["dcsOn"], "qint32", "");
    
    ::SWGrpx-100::setValue(&dcs_code, pJson["dcsCode"], "qint32", "");
    
    ::SWGrpx-100::setValue(&dcs_positive, pJson["dcsPositive"], "qint32", "");
