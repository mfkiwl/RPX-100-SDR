...
SWGSSBDemodSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&agc_clamping, pJson["agcClamping"], "qint32", "");
    
    ::SWGrpx-100::setValue(&agc_time_log2, pJson["agcTimeLog2"], "qint32", "");
    
    ::SWGrpx-100::setValue(&agc_power_threshold, pJson["agcPowerThreshold"], "qint32", "");
    
    ::SWGrpx-100::setValue(&agc_threshold_gate, pJson["agcThresholdGate"], "qint32", "");
