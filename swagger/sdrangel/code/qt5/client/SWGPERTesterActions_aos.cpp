...
SWGPERTesterActions_aos::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&satellite_name, pJson["satelliteName"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&aos_time, pJson["aosTime"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&los_time, pJson["losTime"], "QString", "QString");
