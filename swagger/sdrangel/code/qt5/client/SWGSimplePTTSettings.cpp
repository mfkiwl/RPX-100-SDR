...
SWGSimplePTTSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&rx_device_set_index, pJson["rxDeviceSetIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&tx_device_set_index, pJson["txDeviceSetIndex"], "qint32", "");
    
    ::SWGrpx-100::setValue(&rx2_tx_delay_ms, pJson["rx2TxDelayMs"], "qint32", "");
    
    ::SWGrpx-100::setValue(&tx2_rx_delay_ms, pJson["tx2RxDelayMs"], "qint32", "");
