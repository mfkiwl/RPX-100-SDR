...
SWGRtlSdrSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&low_sample_rate, pJson["lowSampleRate"], "qint32", "");
    
    ::SWGrpx-100::setValue(&center_frequency, pJson["centerFrequency"], "qint64", "");
    
    ::SWGrpx-100::setValue(&gain, pJson["gain"], "qint32", "");
    
    ::SWGrpx-100::setValue(&lo_ppm_correction, pJson["loPpmCorrection"], "qint32", "");
    ...
    ::SWGrpx-100::setValue(&iq_imbalance, pJson["iqImbalance"], "qint32", "");
    
    ::SWGrpx-100::setValue(&agc, pJson["agc"], "qint32", "");
    
    ::SWGrpx-100::setValue(&no_mod_mode, pJson["noModMode"], "qint32", "");
    
    ::SWGrpx-100::setValue(&offset_tuning, pJson["offsetTuning"], "qint32", "");
    ...
    ::SWGrpx-100::setValue(&bias_tee, pJson["biasTee"], "qint32", "");
