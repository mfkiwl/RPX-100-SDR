...
SWGLoggingInfo::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&console_level, pJson["consoleLevel"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&file_level, pJson["fileLevel"], "QString", "QString");
    
    ::SWGrpx-100::setValue(&dump_to_file, pJson["dumpToFile"], "qint32", "");
