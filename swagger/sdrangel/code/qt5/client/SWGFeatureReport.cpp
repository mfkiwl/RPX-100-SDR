...
SWGFeatureReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&afc_report, pJson["AFCReport"], "SWGAFCReport", "SWGAFCReport");
    
    ::SWGrpx-100::setValue(&simple_ptt_report, pJson["SimplePTTReport"], "SWGSimplePTTReport", "SWGSimplePTTReport");
