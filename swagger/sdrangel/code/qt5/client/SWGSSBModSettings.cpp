...
SWGSSBModSettings::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&bandwidth, pJson["bandwidth"], "float", "");
    
    ::SWGrpx-100::setValue(&low_cutoff, pJson["lowCutoff"], "float", "");
    
    ::SWGrpx-100::setValue(&usb, pJson["usb"], "qint32", "");
    
    ::SWGrpx-100::setValue(&tone_frequency, pJson["toneFrequency"], "float", "");
    
    ::SWGrpx-100::setValue(&volume_factor, pJson["volumeFactor"], "float", "");
    
    ::SWGrpx-100::setValue(&span_log2, pJson["spanLog2"], "qint32", "");
    
    ::SWGrpx-100::setValue(&audio_binaural, pJson["audioBinaural"], "qint32", "");
    
    ::SWGrpx-100::setValue(&audio_flip_channels, pJson["audioFlipChannels"], "qint32", "");
    
    ::SWGrpx-100::setValue(&dsb, pJson["dsb"], "qint32", "");
    
    ::SWGrpx-100::setValue(&audio_mute, pJson["audioMute"], "qint32", "");
    
    ::SWGrpx-100::setValue(&play_loop, pJson["playLoop"], "qint32", "");
    
    ::SWGrpx-100::setValue(&agc, pJson["agc"], "qint32", "");
    
    ::SWGrpx-100::setValue(&cmp_pre_gain_db, pJson["cmpPreGainDB"], "qint32", "");
    
    ::SWGrpx-100::setValue(&cmp_threshold_db, pJson["cmpThresholdDB"], "qint32", "");
    ...
    ::SWGrpx-100::setValue(&mod_af_input, pJson["modAFInput"], "qint32", "");
    ...
    ::SWGrpx-100::setValue(&cw_keyer, pJson["cwKeyer"], "SWGCWKeyerSettings", "SWGCWKeyerSettings");
