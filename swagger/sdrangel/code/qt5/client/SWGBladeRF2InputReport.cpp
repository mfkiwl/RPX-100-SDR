...
SWGBladeRF2InputReport::fromJsonObject(QJsonObject &pJson) {
    ::SWGrpx-100::setValue(&frequency_range, pJson["frequencyRange"], "SWGFrequencyRange", "SWGFrequencyRange");
    
    ::SWGrpx-100::setValue(&sample_rate_range, pJson["sampleRateRange"], "SWGRange", "SWGRange");
    
    ::SWGrpx-100::setValue(&bandwidth_range, pJson["bandwidthRange"], "SWGRange", "SWGRange");
    
    ::SWGrpx-100::setValue(&global_gain_range, pJson["globalGainRange"], "SWGRange", "SWGRange");
    
    
    ::SWGrpx-100::setValue(&gain_modes, pJson["gainModes"], "QList", "SWGNamedEnum");
}
