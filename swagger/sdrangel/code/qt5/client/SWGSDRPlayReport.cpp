...
SWGSDRPlayReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGrpx-100::setValue(&sample_rates, pJson["sampleRates"], "QList", "SWGSampleRate");
    
    ::SWGrpx-100::setValue(&bandwidths, pJson["bandwidths"], "QList", "SWGBandwidth");
    
    ::SWGrpx-100::setValue(&intermediate_frequencies, pJson["intermediateFrequencies"], "QList", "SWGFrequency");
    
    ::SWGrpx-100::setValue(&frequency_bands, pJson["frequencyBands"], "QList", "SWGFrequencyBand");
}
