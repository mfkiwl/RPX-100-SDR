...
int DeviceSet::webapiSpectrumSettingsGet(SWGRPX100::SWGGLSpectrum& response, QString& errorMessage) const
{
...
int DeviceSet::webapiSpectrumServerGet(SWGRPX100::SWGSpectrumServer& response, QString& errorMessage) const
{
    return m_spectrumVis->webapiSpectrumServerGet(response, errorMessage);
}

int DeviceSet::webapiSpectrumServerPost(SWGRPX100::SWGSuccessResponse& response, QString& errorMessage)
{
    return m_spectrumVis->webapiSpectrumServerPost(response, errorMessage);
}

int DeviceSet::webapiSpectrumServerDelete(SWGRPX100::SWGSuccessResponse& response, QString& errorMessage)
{
