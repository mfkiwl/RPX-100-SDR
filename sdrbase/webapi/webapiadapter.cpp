///////////////////////////////////////////////////////////////////////////////////
// Copyright (C) 2017-2020 Bernhard Isemann, oe3bia.                             //
//                                                                               //
        ...
        SWGRPX100::SWGErrorResponse& error)
{
    ...
    *response.getOs() = QString(QSysInfo::prettyProductName());
    ...
    SWGRPX100::SWGLoggingInfo *logging = response.getLogging();
    logging->init();
    ...
    SWGRPX100::SWGDeviceSetList *deviceSetList = response.getDevicesetlist();
    getDeviceSetList(deviceSetList);

    SWGRPX100::SWGFeatureSetList *featureSetList = response.getFeaturesetlist();
        ...
        SWGRPX100::SWGErrorResponse& error)
{
    ...
    SWGRPX100::SWGPreferences *preferences = response.getPreferences();
    WebAPIAdapterBase::webapiFormatPreferences(preferences, m_mainCore->m_settings.getPreferences());
    SWGRPX100::SWGPreset *workingPreset = response.getWorkingPreset();
    webAPIAdapterBase.webapiFormatPreset(workingPreset, m_mainCore->m_settings.getWorkingPresetConst());
    SWGRPX100::SWGFeatureSetPreset *workingFeatureSetPreset = response.getWorkingFeatureSetPreset();
    ...
    QList<SWGRPX100::SWGFeatureSetPreset*> *swgFeatureSetPresets = response.getFeaturesetpresets();

    for (int i = 0; i < nbFeatureSetPresets; i++)
    {
        const FeatureSetPreset *preset = m_mainCore->m_settings.getFeatureSetPreset(i);
        swgFeatureSetPresets->append(new SWGRPX100::SWGFeatureSetPreset);
        ...
        SWGRPX100::SWGErrorResponse& error)
{
    ...
    for (; presetKeysIt != configKeys.m_presetKeys.end(); ++presetKeysIt, i++)
    {
        ...
        SWGRPX100::SWGPreset *swgPreset = query.getPresets()->at(i);
    ...
    for (; commandKeysIt != configKeys.m_commandKeys.end(); ++commandKeysIt, i++)
    {
        ...
        SWGRPX100::SWGCommand *swgCommand = query.getCommands()->at(i);
    ...
    for (; featureSetPresetKeysIt != configKeys.m_featureSetPresetKeys.end(); ++featureSetPresetKeysIt, i++)
    {
        ...
        SWGRPX100::SWGFeatureSetPreset *swgPreset = query.getFeaturesetpresets()->at(i);
            ...
            SWGRPX100::SWGErrorResponse& error)
{
    ...
    QList<SWGRPX100::SWGDeviceListItem*> *devices = response.getDevices();
    ...
    for (int i = 0; i < nbSamplingDevices; i++)
    {
        ...
        devices->append(new SWGRPX100::SWGDeviceListItem);
        devices->back()->init();
            ...
            SWGRPX100::SWGErrorResponse& error)
{
    ...
    QList<SWGRPX100::SWGChannelListItem*> *channels = response.getChannels();

    for (int i = 0; i < nbChannelDevices; i++)
    {
        channels->append(new SWGRPX100::SWGChannelListItem);
        channels->back()->init();
            ...
            SWGRPX100::SWGErrorResponse& error)
{
    ...
    QList<SWGRPX100::SWGFeatureListItem*> *features = response.getFeatures();

    for (int i = 0; i < nbFeatureDevices; i++)
    {
        features->append(new SWGRPX100::SWGFeatureListItem);
        features->back()->init();
        ...
        SWGRPX100::SWGErrorResponse& error)
{
    ...
    QList<SWGRPX100::SWGAudioInputDevice*> *inputDevices = response.getInputDevices();
    QList<SWGRPX100::SWGAudioOutputDevice*> *outputDevices = response.getOutputDevices();
    AudioDeviceManager::InputDeviceInfo inputDeviceInfo;
    AudioDeviceManager::OutputDeviceInfo outputDeviceInfo;

    // system default input device
    inputDevices->append(new SWGRPX100::SWGAudioInputDevice);
    ...
    *inputDevices->back()->getName() = AudioDeviceManager::m_defaultDeviceName;
    ...
    outputDevices->append(new SWGRPX100::SWGAudioOutputDevice);
            ...
            SWGRPX100::SWGErrorResponse& error)
{
    ...
    QList<SWGRPX100::SWGDVSerialDevice*> *deviceNamesList = response.getDvSerialDevices();

    std::vector<std::string>::iterator it = deviceNames.begin();

    while (it != deviceNames.end())
    {
        deviceNamesList->append(new SWGRPX100::SWGDVSerialDevice);
        ...
        SWGRPX100::SWGErrorResponse& error)
{
    ...
    dspEngine->getDVSerialNames(deviceNames);
    response.setNbDevices((int) deviceNames.size());
    QList<SWGRPX100::SWGAMBEDevice*> *deviceNamesList = response.getAmbeDevices();

    std::vector<std::string>::iterator it = deviceNames.begin();

    while (it != deviceNames.end())
    {
        deviceNamesList->append(new SWGRPX100::SWGAMBEDevice);
        deviceNamesList->back()->init();
        ...
        SWGRPX100::SWGErrorResponse& error)
{
    ...
    QList<SWGRPX100::SWGAMBEDevice *> *ambeList = query.getAmbeDevices();

    for (QList<SWGRPX100::SWGAMBEDevice *>::const_iterator it = ambeList->begin(); it != ambeList->end(); ++it) {
        ...
        SWGRPX100::SWGErrorResponse& error)
{
    ...
    QList<SWGRPX100::SWGLimeRFEDevice*> *deviceNamesList = response.getLimeRfeDevices();
    std::vector<std::string>::iterator it = comPorts.begin();

    while (it != comPorts.end())
    {
        deviceNamesList->append(new SWGRPX100::SWGLimeRFEDevice);
        deviceNamesList->back()->init();
        *deviceNamesList->back()->getDeviceRef() = QString::fromStdString(*it);
        ++it;
    }
        ...
        SWGRPX100::SWGErrorResponse& error)
{
    ...
    QString groupName;
    response.init();
    QList<SWGRPX100::SWGPresetGroup*> *groups = response.getGroups();
    QList<SWGRPX100::SWGPresetItem*> *swgPresets = 0;
    int i = 0;
    ...
    for (; i < nbPresets; i++)
    {
        ...
        if ((i == 0) || (groupName != preset->getGroup())) // new group
        {
            ...
            groups->append(new SWGRPX100::SWGPresetGroup);
            groups->back()->init();
        ...
        swgPresets->append(new SWGRPX100::SWGPresetItem);
        ...
        SWGRPX100::SWGErrorResponse& error)
{
    ...
    SWGRPX100::SWGPresetIdentifier *presetIdentifier = query.getPreset();
        ...
        SWGRPX100::SWGErrorResponse& error)
{
    ...
    QString groupName;
    response.init();
    QList<SWGRPX100::SWGFeaturePresetGroup*> *groups = response.getGroups();
    QList<SWGRPX100::SWGFeaturePresetItem*> *swgPresets = 0;
    int i = 0;
    ...
    for (; i < nbPresets; i++)
    {
        ...
        {
            if (i > 0) { groups->back()->setNbPresets(nbPresetsThisGroup); }
            groups->append(new SWGRPX100::SWGFeaturePresetGroup);
            groups->back()->init();
            groupName = preset->getGroup();
            *groups->back()->getGroupName() = groupName;
            swgPresets = groups->back()->getPresets();
        ...
        swgPresets->append(new SWGRPX100::SWGFeaturePresetItem);
        swgPresets->back()->init();
...
void WebAPIAdapter::getDeviceSetList(SWGRPX100::SWGDeviceSetList* deviceSetList)
{
    deviceSetList->init();
    ...
    {
        QList<SWGRPX100::SWGDeviceSet*> *deviceSets = deviceSetList->getDeviceSets();
        deviceSets->append(new SWGRPX100::SWGDeviceSet());

        getDeviceSet(deviceSets->back(), *it, i);
    }
}

void WebAPIAdapter::getDeviceSet(SWGRPX100::SWGDeviceSet *swgDeviceSet, const DeviceSet* deviceSet, int deviceSetIndex)
{
    swgDeviceSet->init();
    SWGRPX100::SWGSamplingDevice *samplingDevice = swgDeviceSet->getSamplingDevice();
    samplingDevice->init();
    ...
    if (deviceSet->m_deviceSinkEngine) // Single Tx data
    {
        ...
        *samplingDevice->getSerial() = deviceSet->m_deviceAPI->getSamplingDeviceSerial();
        ...
        QList<SWGRPX100::SWGChannel*> *channels = swgDeviceSet->getChannels();

        for (int i = 0; i <  swgDeviceSet->getChannelcount(); i++)
        {
            channels->append(new SWGRPX100::SWGChannel);
            channels->back()->init();
...
void WebAPIAdapter::getChannelsDetail(SWGRPX100::SWGChannelsDetail *channelsDetail, const DeviceSet* deviceSet)
{
    channelsDetail->init();
    SWGRPX100::SWGChannelReport *channelReport;
    ...
    if (deviceSet->m_deviceSinkEngine) // Tx data
    {
        ...
        QList<SWGRPX100::SWGChannel*> *channels = channelsDetail->getChannels();
        ...
        for (int i = 0; i <  channelsDetail->getChannelcount(); i++)
        {
            ...
            channelReport = new SWGRPX100::SWGChannelReport();
...
void WebAPIAdapter::getFeatureSetList(SWGRPX100::SWGFeatureSetList* featureSetList)
{
    featureSetList->init();
    ...
    {
        QList<SWGRPX100::SWGFeatureSet*> *featureSets = featureSetList->getFeatureSets();
        featureSets->append(new SWGRPX100::SWGFeatureSet());

        getFeatureSet(featureSets->back(), *it, i);
    }
}

void WebAPIAdapter::getFeatureSet(SWGRPX100::SWGFeatureSet *swgFeatureSet, const FeatureSet* featureSet, int featureSetIndex)
{
    ...
    QList<SWGRPX100::SWGFeature*> *features = swgFeatureSet->getFeatures();

    for (int i = 0; i < featureSet->getNumberOfFeatures(); i++)
    {
        const Feature *feature = featureSet->getFeatureAt(i);
        features->append(new SWGRPX100::SWGFeature);
        features->back()->setIndex(i);
        QString s;
        feature->getTitle(s);
