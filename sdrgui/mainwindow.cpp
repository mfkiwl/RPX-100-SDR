	...
	m_sampleFileName(std::string("./test.sdriq"))
{
    ...
    QPixmap logoPixmap(":/RPX100_logo.png");
    RPX100Splash *splash = new RPX100Splash(logoPixmap);
...
void MainWindow::createStatusBar()
{
    ...
    m_showSystemWidget = new QLabel("RPX100 " + qApp->applicationVersion() + " " + qtVersionStr
            + QSysInfo::currentCpuArchitecture() + " " + QSysInfo::prettyProductName(), this);
#else
    m_showSystemWidget = new QLabel("RPX100 " + qApp->applicationVersion() + " " + qtVersionStr, this);
#endif
